...
namespace spotify.DBus
{
    ...
    static class PlayerExtensions
    {
        ...
        public static Task<bool> GetShuffleAsync(this IPlayer o) => o.GetAsync<bool>("Shuffle");
        ...
        public static Task SetShuffleAsync(this IPlayer o, bool val) => o.SetAsync("Shuffle", val);
